...
class DocumentConverter:
    ...
    def chunk_documents(self, documents: List[Document] = None) -> List[Document]:
        ...
        self.logger.info("[PROC] Splitting documents into chunks for RAG optimization...")
        self.logger.info("=" * 60)
        ...
        self.logger.info("[CONFIG] Text Splitter Configuration:")
        self.logger.info(f"  [SIZE] Chunk size: {self.config.chunk_size} characters")
        self.logger.info(f"  [LINK] Chunk overlap: {self.config.chunk_overlap} characters")
        self.logger.info("  [STATS] Hierarchical splitting: Headers → Paragraphs → Sentences")
        
        # Split all documents
        self.logger.info(f"\n[PROC] Splitting {len(documents)} documents into chunks...")
        self.chunked_documents = text_splitter.split_documents(documents)
        
        # Analyze chunking results
        self._analyze_chunking_results(documents)
